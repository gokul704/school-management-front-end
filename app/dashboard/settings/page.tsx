...
import { Settings, User, Bell, Shield, Moon, Sun, Image, Upload } from 'lucide-react';
...
export default function SettingsPage() {
  ...
  const onUpdateProfile = async (data: ProfileFormData) => {
    try {
      ...
      dispatch(getCurrentUser()); // Refresh user data in store
      toast({
        title: 'Success',
    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="profile" className="space-y-4">
        <TabsList>
          ...
          {isAdmin && <TabsTrigger value="school">School Settings</TabsTrigger>}
        </TabsList>
          ...
          <TabsContent value="school" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Upload and manage the school logo</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  ...
                  {logoUrl ? (
                    <div className="flex items-center gap-4">
                      <img
                        ...
                        alt="School Logo"
                        className="h-20 w-20 object-contain border rounded p-2 bg-background"
                        onError={() => setLogoUrl(null)}
                      />
                      <div className="text-sm text-muted-foreground">
                        Logo will be displayed in the sidebar and header
                      </div>
                    </div>
                  ) : (
                    <div className="text-sm text-muted-foreground">
