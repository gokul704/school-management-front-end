                    ...
                    <TableBody>
                      {assignments.map((assignment) => (
                        <TableRow key={assignment.id}>
                          ...
                          <TableCell>{format(new Date(assignment.dueDate), 'MMM dd, yyyy HH:mm')}</TableCell>
                    ...
                    <TableBody>
                      {exams.map((exam) => (
                        <TableRow key={exam.id}>
                          ...
                          <TableCell>
                            {format(new Date(exam.examDate), 'MMM dd, yyyy HH:mm')}
                          </TableCell>
                          <TableCell>
                            <div className="flex items-center gap-2">
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Semester: {timetable.semester}</p>
                    </div>
                  </div>
                  <div className="overflow-x-auto">
                    <Table>
